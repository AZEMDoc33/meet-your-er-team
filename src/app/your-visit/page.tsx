...
const STEPS = [
  ...
  { t: "4. Results & reassessment", d: "This is usually the longest part of your visit. Most lab tests take 1 to 2 hours to process. CT scans must be performed, processed, and read by a radiologist. While you wait, the team is monitoring you and reviewing results as they arrive. Quiet does not mean forgotten." },
